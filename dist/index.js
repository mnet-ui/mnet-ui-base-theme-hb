...
var _RightArrow = require("mnet-icons/dist/es6/icons/hb/RightArrow");
              ...
              item: {
                ...
                extend: function extend(_ref8) {
                  ...
                  return {
                    fontSize: baseSpacing * 0.875 + "px",
                    fontWeight: '600',
                    color: (0, _colors.normalizeColor)(isActive ? 'brand' : 'dark-1', theme),
          ...
          datepicker: {
            ...
            calendar: {
              ...
              header: {
                ...
                icons: {
                  prev: _LeftArrow.LeftArrow,
                  next: _RightArrow.RightArrow,
                  color: 'dark-8',
      ...
      option: {
        ...
        extend: function extend(_ref13) {
          ...
          return {
            ...
            '&:hover': {
              borderColor: (0, _colors.normalizeColor)('light-3', theme)
            }
          };
        }
      },
      ...
      extend: function extend(_ref14) {
        ...
        return {
          ...
          '&:focus': {
            boxShadow: 'none',
            borderColor: 'white',
            borderBottom: theme.global.borderSize.small + " solid " + (!readOnly && (0, _colors.normalizeColor)('accent-3', theme)),
            background: "" + (!readOnly && (0, _colors.normalizeColor)('light-1', theme)),
    ...
    multipurposeSelect: {
      ...
      placeholder: {
        extend: function extend(_ref19) {
          ...
          return "\n        color : " + (0, _colors.normalizeColor)('dark-2', theme) + "\n        ";
        }
      },
      iconContainer: {
        border: {
