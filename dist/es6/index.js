...
export var generate = function generate(baseSpacing, scale) {
  ...
  var result = {
    ...
    pagination: {
      ...
      control: {
        extend: function extend(props) {
          return css(_templateObject4 || (_templateObject4 = _taggedTemplateLiteralLoose(["\n        &:first-child {\n          border-radius: ", "px 0 0 ", "px;\n          border: ", "px solid ", ";\n          border-right: none;\n          & button {\n            border: none;\n            padding: 0px;\n          }\n        }\n        &:last-child {\n          border-radius: 0 ", "px ", "px 0;\n          border: ", "px solid ", ";\n          & button {\n            border: none;\n            padding: 0px;\n          }\n        }\n      "])), baseSpacing / 4, baseSpacing / 4, controlBorderWidth, normalizeColor('light-4', props.theme), baseSpacing / 4, baseSpacing / 4, controlBorderWidth, normalizeColor('light-4', props.theme));
        }
      }
    },
    notification: {
